...
public class UnderlineTest extends RenderingTestCase {

    private static final Set<Extension> EXTENSIONS = Collections.singleton(UnderlineExtension.create());
    ...
    public void delimited() {
        ...
        Underline ins = (Underline) document.getFirstChild().getFirstChild();
